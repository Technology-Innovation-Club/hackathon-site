      ...
      <div className="relative aspect-square w-full max-w-4xl">
        ...
        <div className="z-10 hidden h-full grid-cols-11 grid-rows-11 gap-3 md:grid">
          {[
            ...
            { col: "col-span-3 col-start-4", row: "row-span-2 row-start-1", img: "DSC_0493.png", delay: 0.1 },
            ...
            { col: "col-span-4 col-start-3", row: "row-span-3 row-start-3", img: "DSC_0703.png", delay: 0.5 },
            { col: "col-span-5 col-start-7", row: "row-span-4 row-start-4", img: "DSC_0683.jpg", delay: 0.6 },
            { col: "col-span-4 col-start-1", row: "row-span-3 row-start-6", img: "DSC_0532.png", delay: 0.7 },
            ...
            { col: "col-span-2 col-start-5", row: "row-span-2 row-start-10", img: "DSC_0022.png", delay: 1.2 },
          ].map((item, index) => (
            <motion.div
              key={index}
